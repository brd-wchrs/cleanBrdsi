...
//        echo "<input type='hidden' id='wordcloudJSON' value='".."' >";
        ...
        profileEventCompleted("generated wordcloud");
		    ...
		    echo '<canvas id="tagsChart" class="barCharts" width="700" height="400"></canvas>' ;
			echo "</div>" ;
			echo "</div>" ;
		    echo '<br>' ;
			...
			echo '<canvas id="usersChart" class="barCharts" width="650" height="400"></canvas>' ;
		    echo "</div>" ;
		    echo '<br>' ;
			...
			echo "<div class='section group'>" ;
			echo "<div class='col span_1_of_2 statsTable weekStats'>" ;
